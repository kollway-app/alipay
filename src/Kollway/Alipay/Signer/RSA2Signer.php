...
class RSA2Signer implements SignerInterface
{
    ...
    public function sign($raw)
    {
        ...
        openssl_sign($raw, $sign, $key, OPENSSL_ALGO_SHA256);
    ...
    public function verify($raw, $sign)
    {
        ...
        $verify = openssl_verify($raw, $sign, $key, OPENSSL_ALGO_SHA256);
        openssl_free_key($key);
        return $verify === 1;
    }
